<template>
  <div class="group flex items-stretch gap-4">
    ...
    <div
      class="relative my-1 min-w-0 grow rounded-lg border border-neutral-200 bg-white px-3 pt-1 pb-2 group-hover:border-neutral-400 first:mt-0 sm:px-4 sm:pt-2 sm:pb-3"
    >
      <NuxtLink
